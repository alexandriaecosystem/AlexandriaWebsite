...
describe('document availability guidance', () => {
  it('only labels processed, approved documents with indexed content as available', async () => {
    const documents: KnowledgeDocumentSummary[] = [
      { id: 'available', title: 'Published guide', category: 'PROJECT_OFFICIAL', language: 'en', version: 1, processingStatus: 'READY', isApproved: true, chunkCount: 5, processingError: null, approvedBy: 'admin', approvedAt: '2026-09-04T00:00:00Z', createdAt: '2026-09-04T00:00:00Z', updatedAt: '2026-09-04T00:00:00Z' },
      { id: 'review', title: 'Needs review', category: 'PROJECT_OFFICIAL', language: 'en', version: 1, processingStatus: 'READY', isApproved: false, chunkCount: 5, processingError: null, approvedBy: null, approvedAt: null, createdAt: '2026-09-04T00:00:00Z', updatedAt: '2026-09-04T00:00:00Z' },
      { id: 'empty', title: 'Empty source', category: 'PROJECT_OFFICIAL', language: 'en', version: 1, processingStatus: 'READY', isApproved: true, chunkCount: 0, processingError: null, approvedBy: 'admin', approvedAt: '2026-09-04T00:00:00Z', createdAt: '2026-09-04T00:00:00Z', updatedAt: '2026-09-04T00:00:00Z' },
      { id: 'failed', title: 'Failed source', category: 'PROJECT_OFFICIAL', language: 'en', version: 1, processingStatus: 'FAILED', isApproved: true, chunkCount: 5, processingError: 'Extraction failed', approvedBy: 'admin', approvedAt: '2026-09-04T00:00:00Z', createdAt: '2026-09-04T00:00:00Z', updatedAt: '2026-09-04T00:00:00Z' },
    ];
